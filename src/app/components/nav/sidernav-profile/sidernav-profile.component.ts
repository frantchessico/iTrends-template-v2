...
@Component({
  selector: 'app-sidernav-profile',
  templateUrl: './sidernav-profile.component.html',
  styleUrls: ['./sidernav-profile.component.css']
})
export class SidernavProfileComponent implements OnInit {
  public btn = false;
